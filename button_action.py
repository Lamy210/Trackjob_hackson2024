...
#音声処理
#delay_entry, pitch_var, own_key_var, stream_key_var, own_interface_var, stream_interface_var
#audio_path 音楽のファイルパス

#音声キー処理
def play_voice_processing():

    print("play_voice_processing:start")
    ...
    print("play_voice_processing:end")
